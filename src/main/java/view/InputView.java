...
public class InputView {
    private static final String FUNCTION_SELECT = "## 원하는 기능을 선택하세요.";
    private static final String TABLE_SELECT = "## 테이블을 선택하세요.";
    private static final String MENU_ORDER = "## 등록할 메뉴를 선택하세요.";
    private static final String QUANTITY = "## 메뉴의 수량을 입력하세요.";
    private static final String PAYMENT_PROCESS = "## %d번 테이블의 결제를 진행합니다.\n";
    private static final String PAYMENT_TOOLS = "## 신용 카드는 1번, 현금은 2번";
